...
class Order(models.Model):
    ...
    bonus_spent = models.FloatField(verbose_name=_('Использованные бонусы'), default=0)
    bonus_earned = models.FloatField(verbose_name=_('Заработанные бонусы'), default=0)
